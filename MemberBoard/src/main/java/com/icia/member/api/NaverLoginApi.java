...
public class NaverLoginApi {
	...
	private final static String CLIENT_ID = "T64zjW3U0oEe32dQ6JvO";
	private final static String CLIENT_SECRET = "UKrveHjYAc";

	private final static String REDIRECT_URI = "http://localhost:8079/member/naverloginok";
