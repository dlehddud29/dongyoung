...
@Component//component는 개발자가 직접 작성한 클래스를 사용하기 위해서 사용하는 어노테이션이다
public class KakaoJoinApi {
	// 카카오 개발자 페이지의 REST API 키 값 
	private final static String K_CLIENT_ID = "9de7b3888812dff3f839610a708d3d34"; 
	// 카카오 개발자 페이지에서  로그인 Redirect URI 에 설정한 값 
	private final static String K_REDIRECT_URI = "http://localhost:8079/member/kakaojoinok";
